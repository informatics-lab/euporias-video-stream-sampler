...
function samplingStart(){
    ...
    createSamples();
    samplingButton.innerHTML = "<i class=\"fa fa-file-word-o\" aria-hidden=\"true\"></i> Stop Sampling";
...
function samplingStop(){ 
    sampling = false;
    clearSamples();
    samplingButton.innerHTML = "<i class=\"fa fa-file-word-o\" aria-hidden=\"true\"></i> Start Sampling";
...
function createSamples() {
    ...
    sampleLoop = setInterval(function () {
		try{
			...
			wordOP.value = wordOP.value + aChar;
...
/*				
					,function(err){
						console.log("Err isRecording  :" + err);
						commsLost();
						}
					).catch(function(error){
						console.log("Caught isRecording " + error);
						commsLost();
						*/
					});
			}else{
